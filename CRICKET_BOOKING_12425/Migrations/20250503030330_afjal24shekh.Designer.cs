...
namespace CRICKET_BOOKING_12425.Migrations
{
    ...
    [Migration("20250503030330_afjal24shekh")]
    partial class afjal24shekh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.AdminNews", b =>
                {
                    b.Property<int>("AdminNewsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdminNewsId"));
                    ...
                    b.HasKey("AdminNewsId");

                    b.HasIndex("MaineAdminId");

                    b.ToTable("AdminNews");
                });

            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.AdminVideo", b =>
                {
                    b.Property<int>("AdminVideoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdminVideoId"));
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.Adminteams", b =>
                {
                    b.Property<int>("AdminteamsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdminteamsId"));
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.Contact", b =>
                {
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.HeaderImg", b =>
                {
                    b.Property<int>("HeaderImgId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HeaderImgId"));
                    ...
                    b.HasKey("HeaderImgId");

                    b.HasIndex("MaineAdminId");

                    b.ToTable("HeaderImgs");
                });

            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.MaineAdmin", b =>
                {
                    b.Property<int>("MaineAdminId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaineAdminId"));
                    ...
                    b.HasKey("MaineAdminId");

                    b.ToTable("MaineAdmins");
                });

            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.New", b =>
                {
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.AdminNews", b =>
                {
                    b.HasOne("CRICKET_BOOKING_12425.Models.MaineAdmin", "MaineAdmin")
                        .WithMany("AdminNews")
                        .HasForeignKey("MaineAdminId");

                    b.Navigation("MaineAdmin");
                });

            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.AdminVideo", b =>
                {
                    b.HasOne("CRICKET_BOOKING_12425.Models.MaineAdmin", "MaineAdmin")
                        .WithMany("AdminVideos")
                        .HasForeignKey("MaineAdminId");
            ...
            modelBuilder.Entity("CRICKET_BOOKING_12425.Models.MaineAdmin", b =>
                {
                    b.Navigation("AdminNews");

                    b.Navigation("AdminVideos");

                    b.Navigation("Adminteams");

                    b.Navigation("Contacts");

                    b.Navigation("HeaderImg");
                });
